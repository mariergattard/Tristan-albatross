...
## Licence
The satellite images and annotations are subject to the <a href="https://www.maxar.com/legal/internal-use-license" target="_blank">Maxar Satellite Imagery License Agreement</a>. The python script and all other data in this repository is governed by the <a href="http://www.nerc.ac.uk/research/sites/data/policy/" target="_blank">NERC data policy</a> and supplied under <a href="http://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/" target="_blank">Open Government Licence v.3</a>.
